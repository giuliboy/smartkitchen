...
namespace HSR.CloudSolutions.SmartKitchen.Simulator.Simulation.Devices
{
    public class SimOven : BaseSimDevice<OvenDTO>
    {
        ...
        private ISimulation Heating(TimeSpan interval)
        {
            ...
            return new IntervalSimulation<double>(dt => this.Temperature += dt, () => 3.0, interval, () => this.Temperature >= this.SimulationTargetTemperature, () => this._temperatureState = DeviceTemperatureState.Heating, () => this._temperatureState = DeviceTemperatureState.None);
        }
        ...
        private ISimulation Cooling(TimeSpan interval)
        {
            ...
            return new IntervalSimulation<double>(dt => this.Temperature -= dt, () => .5, interval, () => this.Temperature <= this.SimulationTargetTemperature, () => this._temperatureState = DeviceTemperatureState.Cooling, () => this._temperatureState = DeviceTemperatureState.None);
        }
